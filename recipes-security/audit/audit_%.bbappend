...
do_install:append() {
    ...
    cat ${D}${sysconfdir}/audit/audit.rules ${WORKDIR}/security.rules \
    ...
    install -m 0644 ${WORKDIR}/audit-rules-override.conf ${D}${systemd_unitdir}/system/audit-rules.service.d/override.conf
