...
- `SECURITY_PROFILE`: `dev` *(default)* for bring-up (serial console, debug tweaks, IMA/EVM/verity non-enforcing) or `prod` for release (silent boot, enforcing integrity, locked device key).
