...
- Issues in poky, meta-raspberrypi, meta-openembedded, meta-security,
  meta-selinux, or the Linux kernel
- Physical attacks (bus probing, glitching, side-channel)
- Misuse caused by ignoring documented warnings (e.g., losing signing keys
  after burning OTP fuses)
