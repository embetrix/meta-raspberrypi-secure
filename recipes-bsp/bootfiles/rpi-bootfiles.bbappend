...
do_deploy:append:raspberrypi4-64() {
    install -m 0644 ${UNPACKDIR}/raspberrypi-firmware-2026/start4.elf  ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/start4.elf
    install -m 0644 ${UNPACKDIR}/raspberrypi-firmware-2026/fixup4.dat  ${DEPLOYDIR}/${BOOTFILES_DIR_NAME}/fixup4.dat
}
